...
# Single place to change the HUD typeface — used everywhere QFont is built below.
# Falls back through common system sans fonts on non-Windows machines so the UI
# never silently drops to a serif/default font if "Segoe UI" isn't installed.
FONT_FAMILY = "Segoe UI"
FONT_FALLBACKS = ["Segoe UI", "Helvetica Neue", "Arial", "sans-serif"]
...
class MetricBar(QWidget):
    ...
    def paintEvent(self, _):
        ...
        p.setFont(QFont(FONT_FAMILY, 7, QFont.Weight.Bold))
...
class _DropCanvas(QWidget):
    ...
    def _paint_drag_over(self, p, W, H):
        cx, cy = W / 2, H / 2
        p.setFont(QFont(FONT_FAMILY, 20))
...
class _CameraPreview(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        title.setFont(QFont(FONT_FAMILY, 7, QFont.Weight.Bold))
        title.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        hdr.addWidget(title)
        hdr.addStretch()
        close_btn = QPushButton("✕")
        close_btn.setFixedSize(16, 16)
        close_btn.setFont(QFont(FONT_FAMILY, 8))
...
class SetupOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        def _lbl(txt, font_size=9, bold=False, color=C.PRI,
            ...
            w.setFont(QFont(FONT_FAMILY, font_size,
        ...
        self._key_input.setFont(QFont(FONT_FAMILY, 10))
        ...
        init_btn.setFont(QFont(FONT_FAMILY, 10, QFont.Weight.Bold))
...
class CustomizeOverlay(QWidget):
    ...
    def __init__(self, assistant_name="JARVIS", user_name="",
        ...
        def _lbl(txt, fs=9, bold=False, color=C.PRI, align=Qt.AlignmentFlag.AlignCenter):
            ...
            w.setFont(QFont(FONT_FAMILY, fs,
                            QFont.Weight.Bold if bold else QFont.Weight.Normal))
            w.setStyleSheet(f"color: {color}; background: transparent;")
            return w
        ...
        self._name_input.setFont(QFont(FONT_FAMILY, 10))
        ...
        self._user_input.setFont(QFont(FONT_FAMILY, 10))
        ...
        for _v in AVAILABLE_VOICES:
            ...
            b.setCheckable(True)
            b.setFixedHeight(28)
            b.setFont(QFont(FONT_FAMILY, 8, QFont.Weight.Bold))
        ...
        df_btn.setFont(QFont(FONT_FAMILY, 7, QFont.Weight.Bold))
        ...
        self._hex_input.setFont(QFont(FONT_FAMILY, 10))
        ...
        save_btn.setFont(QFont(FONT_FAMILY, 9, QFont.Weight.Bold))
...
class PluginManagerOverlay(QWidget):
    ...
    def __init__(self, plugins: list[dict], parent=None):
        ...
        hdr.setFont(QFont(FONT_FAMILY, 12, QFont.Weight.Bold))
    ...
    def _build_row(self, p: dict) -> QHBoxLayout:
        ...
        btn.setFont(QFont(FONT_FAMILY, 7, QFont.Weight.Bold))
        if not p["valid"]:
            btn.setText("BROKEN")
...
class ConfirmBanner(_HudOverlay):
    ...
    def __init__(self, title: str, detail: str, parent=None):
        ...
        hdr = QLabel("⚠  CONFIRM")
        hdr.setFont(QFont(FONT_FAMILY, 11, QFont.Weight.Bold))
        hdr.setStyleSheet(f"color: {C.ACC}; background: transparent;")
        lay.addWidget(hdr)

        ttl = QLabel(title)
        ttl.setWordWrap(True)
        ttl.setFont(QFont(FONT_FAMILY, 10, QFont.Weight.Bold))
        ...
        if detail:
            ...
            dtl.setFont(QFont(FONT_FAMILY, 8))
        ...
        yes.setFont(QFont(FONT_FAMILY, 9, QFont.Weight.Bold))
        ...
        no.setFont(QFont(FONT_FAMILY, 9))
...
class AudioDeviceOverlay(_HudOverlay):
    ...
    def __init__(self, parent=None):
        ...
        def _row(label: str, kind: str, current: str) -> QComboBox:
            cap = QLabel(label)
            cap.setFont(QFont(FONT_FAMILY, 8))
            cap.setStyleSheet(f"color: {C.TEXT_DIM}; background: transparent;")
            lay.addWidget(cap)

            box = QComboBox()
            box.setFont(QFont(FONT_FAMILY, 9))
        ...
        note.setFont(QFont(FONT_FAMILY, 7))
        ...
        ok.setFont(QFont(FONT_FAMILY, 9, QFont.Weight.Bold))
        ...
        cancel.setFont(QFont(FONT_FAMILY, 9))
...
class MemoryOverlay(_HudOverlay):
    ...
    def _rebuild(self):
        ...
        cap.setFont(QFont(FONT_FAMILY, 7))
        cap.setStyleSheet(f"color: {C.TEXT_DIM}; background: transparent;")
        self._lay.addWidget(cap)

        if not rows:
            empty = QLabel("Nothing stored yet.")
            empty.setFont(QFont(FONT_FAMILY, 9))
            ...
            for r in rows:
                ...
                meta.setFont(QFont(FONT_FAMILY, 7))
                meta.setStyleSheet(f"color: {C.TEXT_DIM}; background: transparent;")
                line.addWidget(meta)

                rm = QPushButton("✕")
                rm.setFixedSize(20, 20)
                rm.setFont(QFont(FONT_FAMILY, 8, QFont.Weight.Bold))
        ...
        close.setFont(QFont(FONT_FAMILY, 9))
...
class ClipboardPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        icon_lbl.setFont(QFont(FONT_FAMILY, 7, QFont.Weight.Bold))
        icon_lbl.setStyleSheet(f"color: {C.ACC2}; background: transparent;")
        hdr.addWidget(icon_lbl); hdr.addStretch()
        x_btn = QPushButton("✕")
        x_btn.setFixedSize(16, 16)
        x_btn.setFont(QFont(FONT_FAMILY, 8))
        ...
        self._preview.setFont(QFont(FONT_FAMILY, 8))
        ...
        for label, cmd_fmt in [
            ...
            b = QPushButton(label)
            b.setFixedHeight(22)
            b.setFont(QFont(FONT_FAMILY, 7, QFont.Weight.Bold))
            b.setCursor(Qt.CursorShape.PointingHandCursor)
            b.setStyleSheet(_bs)
    ...
    def _build_section(self, form: QVBoxLayout, sec: dict):
        ...
        for field in fields:
            ...
            if ftype == "choice":
                ...
                w.setFixedHeight(28)
                w.setFont(QFont(FONT_FAMILY, 8, QFont.Weight.Bold))
                ...
                w.setFont(QFont(FONT_FAMILY, 10))
                w.setFixedHeight(30)
        ...
        if isinstance(action, dict) and callable(action.get("run")):
            ...
            ab.setFont(QFont(FONT_FAMILY, 8, QFont.Weight.Bold))
...
class RemoteKeyOverlay(QWidget):
    ...
    def __init__(self, url: str, key: str, auto_login_url: str = "",
        ...
        self._url_lbl.setFont(QFont(FONT_FAMILY, 8))
        ...
        self._key_lbl.setFont(QFont(FONT_FAMILY, 28, QFont.Weight.Bold))
        ...
        self._timer_lbl.setFont(QFont(FONT_FAMILY, 8))
        ...
        new_btn.setFont(QFont(FONT_FAMILY, 8, QFont.Weight.Bold))
        ...
        close_btn.setFont(QFont(FONT_FAMILY, 8, QFont.Weight.Bold))
        close_btn.setCursor(Qt.CursorShape.PointingHandCursor)
        close_btn.setStyleSheet(f"""
            QPushButton {{
                background: transparent; color: {C.TEXT_MED};
    ...
    def _update_qr(self, url: str) -> None:
        ...
        try:
            ...
            self._qr_label.setFont(QFont(FONT_FAMILY, 8))
            self._qr_label.setStyleSheet(
                "color: #888; background: white; border-radius: 10px; padding: 4px;"
            )
        except Exception:
            self._qr_label.setText(url[:28])
            self._qr_label.setFont(QFont(FONT_FAMILY, 7))
            self._qr_label.setStyleSheet(
    ...
    def mark_connected(self) -> None:
        ...
        """)
        self._qr_label.setText("✓")
        self._qr_label.setFont(QFont(FONT_FAMILY, 54, QFont.Weight.Bold))
        self._qr_label.setStyleSheet(
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        ...
        _cam_title.setFont(QFont(FONT_FAMILY, 8, QFont.Weight.Bold))
        _cam_title.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        _cam_hdr.addWidget(_cam_title)
        _cam_hdr.addStretch()
        _cam_x = QPushButton("✕  CLOSE")
        _cam_x.setFont(QFont(FONT_FAMILY, 8, QFont.Weight.Bold))
    ...
    def _build_header(self) -> QWidget:
        ...
        self._drawer_btn.setFont(QFont(FONT_FAMILY, 11))
        ...
        self._title_lbl.setFont(QFont(FONT_FAMILY, 17, QFont.Weight.Bold))
        ...
        self._sub_lbl.setFont(QFont(FONT_FAMILY, 7))
        ...
        self._clock_lbl.setFont(QFont(FONT_FAMILY, 14, QFont.Weight.Bold))
        self._clock_lbl.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        self._clock_lbl.setAlignment(Qt.AlignmentFlag.AlignRight)
        right_col.addWidget(self._clock_lbl)
        self._date_lbl = QLabel("")
        self._date_lbl.setFont(QFont(FONT_FAMILY, 7))
    ...
    def _build_left_panel(self) -> QWidget:
        ...
        hdr.setFont(QFont(FONT_FAMILY, 7, QFont.Weight.Bold))
        hdr.setStyleSheet(f"color: {C.PRI}; background: transparent; "
        ...
        self._uptime_lbl.setFont(QFont(FONT_FAMILY, 8, QFont.Weight.Bold))
        self._uptime_lbl.setStyleSheet(f"color: {C.GREEN}; background: transparent; border: none;")
        ip_lay.addWidget(self._uptime_lbl)

        self._proc_lbl = QLabel("PROC  --")
        self._proc_lbl.setFont(QFont(FONT_FAMILY, 8))
        self._proc_lbl.setStyleSheet(f"color: {C.TEXT_MED}; background: transparent; border: none;")
        ip_lay.addWidget(self._proc_lbl)

        os_name = {"Windows": "WIN", "Darwin": "macOS", "Linux": "LINUX"}.get(_OS, _OS.upper())
        os_lbl = QLabel(f"OS  {os_name}")
        os_lbl.setFont(QFont(FONT_FAMILY, 8))
    ...
    def _build_right_panel(self) -> QWidget:
        ...
        def _sec(txt):
            l = QLabel(f"▸ {txt}")
            l.setFont(QFont(FONT_FAMILY, 7, QFont.Weight.Bold))
        ...
        self._file_hint.setFont(QFont(FONT_FAMILY, 7))
        ...
        self._interrupt_btn.setFont(QFont(FONT_FAMILY, 8, QFont.Weight.Bold))
        ...
        self._mute_btn.setFont(QFont(FONT_FAMILY, 8, QFont.Weight.Bold))
    ...
    def _build_quick_drawer(self) -> QWidget:
        ...
        remote_btn.setFont(QFont(FONT_FAMILY, 8, QFont.Weight.Bold))
        ...
        fs_btn.setFont(QFont(FONT_FAMILY, 7))
        ...
        sc_btn.setFont(QFont(FONT_FAMILY, 7))
        ...
        self._autostart_btn.setFont(QFont(FONT_FAMILY, 7))
        ...
        cust_btn.setFont(QFont(FONT_FAMILY, 7))
        ...
        self._brief_btn.setFont(QFont(FONT_FAMILY, 7))
        ...
        self._wake_btn.setFont(QFont(FONT_FAMILY, 7))
        ...
        self._wake_sleep_btn.setFont(QFont(FONT_FAMILY, 7))
        ...
        audio_btn.setFont(QFont(FONT_FAMILY, 7))
        ...
        mem_btn.setFont(QFont(FONT_FAMILY, 7))
        ...
        plugin_btn.setFont(QFont(FONT_FAMILY, 7))
        ...
        settings_btn.setFont(QFont(FONT_FAMILY, 7))
    ...
    def _build_input_row(self) -> QHBoxLayout:
        ...
        self._input.setFont(QFont(FONT_FAMILY, 9))
        ...
        send.setFont(QFont(FONT_FAMILY, 11, QFont.Weight.Bold))
    ...
    def _build_content_panel(self) -> QWidget:
        ...
        dot = QLabel("◈")
        dot.setFont(QFont(FONT_FAMILY, 9, QFont.Weight.Bold))
        dot.setStyleSheet(f"color: {C.PRI}; background: transparent;")
        hdr.addWidget(dot)

        self._content_title_lbl = QLabel("BRIEFING")
        self._content_title_lbl.setFont(QFont(FONT_FAMILY, 8, QFont.Weight.Bold))
        ...
        self._content_ts_lbl.setFont(QFont(FONT_FAMILY, 7))
        self._content_ts_lbl.setStyleSheet(f"color: {C.TEXT_DIM}; background: transparent;")
        hdr.addWidget(self._content_ts_lbl)

        dismiss = QPushButton("DISMISS  ✕")
        dismiss.setFont(QFont(FONT_FAMILY, 7))
        ...
        self._content_display.setFont(QFont(FONT_FAMILY, 8))
    ...
    def _build_footer(self) -> QWidget:
        ...
        def _fl(txt, color=C.TEXT_MED):
            l = QLabel(txt); l.setFont(QFont(FONT_FAMILY, 7))
            l.setStyleSheet(f"color: {color}; background: transparent;")
            return l
